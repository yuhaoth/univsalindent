...
For the Windows Visual Studio 2005 a solution file is included, named "UniversalIndentGUI.sln". Additional include and lib directories for Qt have to be set in the preferences. Have a look at the homepage "http://wiki.qgis.org/qgiswiki/Building_QT_4_with_Visual_C++_2005", where zou will find a good guide how to make Qt's open source edition compileabel with Visual Studio. Even though it is written for Qt 4.1.1 it also fits for the current version 4.2.2.
