			...
			<div id="content">
				...
				<div id="changelog" class="listelemspacing">
    				...
    				<ul>
                        ...
                        <li>[add] Feature Request ID <a href="issue/feature/1752551">1752551</a> : If the user manually checks for updates a progress/busy dialog will be shown.</li>
                        <li>[add] Feature Request ID <a href="issue/feature/1736932">1736932</a> : The user gets shown a dialog if he has manually checked for an update and no new one is available.</li>
                        ...
                        <li>[fix] Bug ID <a href="issue/bug/1807179">1807179</a> : GNU Indent didn't work properly on Windows system, after the dlls libiconv-2.dll and libintl-2.dll were removed. Readded them.</li>
                        <li>[fix] Bug ID <a href="issue/bug/1805976">1805976</a> : The HTML export didn't produce any output. Fixed that, but still has not syntax formatting.</li>
                        <li>[fix] Bug ID <a href="issue/bug/1815023">1815023</a> : Mixed traditional with simplified chinese translation. Now preferring to use english text instead of mixing if no traditional translation is available.</li>
    				...
    				<ul>
                        ...
                        <li>[add] Feature Request ID <a href="issue/feature/1730180">1730180</a> : UniversalIndentGUI can automatically check on start, whether a new version is available. This setting is disabled by default and can be enabled in the settings.</li>
                        <li>[add] Added support for HTML Tidy. The executable is contained in the release package.</li>
                        <li>[add] Feature Request ID <a href="issue/feature/1736432">1736432</a> : The width of the dock widget containing  the indenter parameters is now restored on program start.</li>
                        <li>[change] The about dialog shows now a credits scroller to say thanks to all people, who have helped me somehow.</li>
                        <li>[fix] Bug ID <a href="issue/bug/1733499">1733499</a> : UniversalIndentGui crashed if inside of an indenter ini file the category number of one parameter was higher than the available categories.</li>
                        <li>[fix] Bug ID <a href="issue/bug/1735586">1735586</a> : Some dialogs had untranslated buttons. For example yes, no, cancel were not translated.</li>
                    </ul>
    				...
    				<ul>
                        ...
                        <li>[add] Feature Request ID <a href="issue/feature/1657253">1657253</a> : If now configuration ini file for any indenter can be found, a warning will be displayed.</li>
                        <li>[change] Feature Request ID <a href="issue/feature/1723228">1723228</a> : The default font for all syntax highlighters is now mono spaced, Courier.</li>
                        ...
                        <li>[fix] Bug ID <a href="issue/bug/1692511">1692511</a> : UniversalIndentGui crashed, if a by the syntax highlighter unsupported file extension was opened.</li>
                        <li>[fix] Bug ID <a href="issue/bug/1727538">1727538</a> : The setting for syntax highlighting was allways enabled on startup, even if disabled on closing.</li>
                        <li>[fix] Bug ID <a href="issue/bug/1729026">1729026</a> : The highlighting style was not correct when changed to another highlighter than the current. Only after toggling preview for example the style was correct.</li>
    				...
    				<ul>
                        ...
                        <li>[add] Feature Request ID <a href="issue/feature/1673549">1673549</a> : The order of the indenter call parameters for input file, output file and options[file] is now selectable in three states: pio, ipo, iop.</li>
                        <li>[add] Feature Request ID <a href="issue/feature/1675503">1675503</a> : The last set encoding is being remembered and used on loading last file.</li>
                        <li>[add] Feature Request ID <a href="issue/feature/1669822">1669822</a> : The last window position, size and maximized state is stored in the settings and restored.</li>
                        <li>[add] Feature Request ID <a href="issue/feature/1673670">1673670</a> : Made it possible to switch between visible and invisible white space characters, like spaces and tabs.</li>
                    ...
                    <ul>
                        ...
                        <li>[add] Feature Request ID <a href="issue/feature/1657251">1657251</a> : If only a win32 executable exists under Linux, wine will be used to call it. Now a test will be mad if wine is installed and an error message will show up if not installed.</li>
                        ...
                        <li>[fix] Bug ID <a href="issue/bug/1657255">1657255</a> : If an error occurred during the try to call the indenter, a message box is being shown, but the mouse cursor still indicated that the application is being busy.</li>
                        <li>[fix] Bug ID <a href="issue/bug/1651071">1651071</a> : Changing the file encoding did not affect the code sent to the indenter, so the code while preview turned on, had wrong encoding (still seems to have some encoding problems under Linux).</li>
                        <li>[fix] Bug ID <a href="issue/bug/1650222">1650222</a> : On Windows systems there were two DLLs missing to run GNU Indent ("libiconv-2.dll" and "libintl-2.dll")</li>
