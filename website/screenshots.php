    ...
    <div id="page">
        ...
        <div id="main">
            ...
            <div id="content">
                <h2>Screenshots</h2>
                <br />
                <a href="images/screenshot1.png" rel="lightbox[uiguiscreenshots]" title="UniversalIndentGUI under XP.">
                ...
                <a href="images/screenshot3.png" rel="lightbox[uiguiscreenshots]" title="UniversalIndentGUI under Linux showing the indenter select menu.">
                    <img src="images/screenshot3.jpg" alt="LinuScreenshot3" width="500"/>
                </a>
                <p>UniversalIndentGUI under Linux showing the indenter select menu.</p>

                <br />
                <a href="images/screenshot4.png" rel="lightbox[uiguiscreenshots]" title="UniversalIndentGUI under Linux with outdocked indenter parameter menu.">
                ...
                <br />
                <a href="images/screenshot5.png" rel="lightbox[uiguiscreenshots]" title="The about dialog of UniversalIndentGUI.">
